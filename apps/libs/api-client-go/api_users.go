...
type UsersAPI interface {
	...
	*/
	...
	/*
	ResendEmailVerification Resend the pending OIDC user email verification

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return UsersAPIResendEmailVerificationRequest
	*/
	ResendEmailVerification(ctx context.Context) UsersAPIResendEmailVerificationRequest

	// ResendEmailVerificationExecute executes the request
	ResendEmailVerificationExecute(r UsersAPIResendEmailVerificationRequest) (*http.Response, error)
...
func (r UsersAPIResendEmailVerificationRequest) Execute() (*http.Response, error) {
...
ResendEmailVerification Resend the pending OIDC user email verification
 ...
 @return UsersAPIResendEmailVerificationRequest
*/
func (a *UsersAPIService) ResendEmailVerification(ctx context.Context) UsersAPIResendEmailVerificationRequest {
	return UsersAPIResendEmailVerificationRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *UsersAPIService) ResendEmailVerificationExecute(r UsersAPIResendEmailVerificationRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath := localBasePath + "/users/me/email-verification/resend"
